...
Route::middleware(['web', 'auth', 'practitioners'])->group(function () {
    ...
    Route::get('/trainers', [CounselorController::class, 'apiList'])->name('api.trainers.list');
    Route::post('/training-records/auto-create', [CounselingRecordController::class, 'autoCreate'])->name('api.training-records.auto-create');
});
