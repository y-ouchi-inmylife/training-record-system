...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'counselor2_id' => [
            'different' => '担当2は担当1と異なるカウンセラーを選択してください。',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'initial_age' => '初回時年齢',
        'gender' => '性別',
        'initial_consultation_date' => '初回相談日',
        'phone1' => '電話番号1',
        'phone2' => '電話番号2',
        'phone3' => '電話番号3',
        'email' => 'メールアドレス',
        ...
        'education_level' => '学歴',
        'education_detail' => '学歴の詳細',
        'education_status' => '在学状況',
        'employment_type' => '雇用形態',
        'employment_hours' => '労働時間',
        'employment_period' => '雇用期間',
        'unemployment_period' => '失業期間',
        'employment_detail' => '職歴の詳細',
        'disability_physical' => '身体障害',
        'disability_physical_grade' => '身体障害等級',
        'disability_mental' => '精神障害',
        'disability_mental_grade' => '精神障害等級',
        'disability_intellectual' => '知的障害',
        'disability_intellectual_grade' => '知的障害等級',
        'disability_detail' => '障害の詳細',
        'hospital' => '通院先',
        'medication' => '服薬状況',
        'financial_status' => '経済状況',
        'financial_detail' => '経済状況の詳細',
        'hikikomori' => 'ひきこもり',
        'school_refusal' => '不登校',
        'bullying' => 'いじめ',
        'login_id' => 'ログインID',
        ...
        'password' => 'パスワード',
        'role' => '権限',
        'cooperating_agencies' => '連携機関',
        'primary_counselor_id' => '主担当カウンセラー',
        'support_status_id' => '支援状態',
        'counselor1_id' => '担当1',
        'counselor2_id' => '担当2',
        'consultation_date' => '相談日',
        'consultation_type_id' => '相談内容',
        'phase_id' => 'フェーズ',
