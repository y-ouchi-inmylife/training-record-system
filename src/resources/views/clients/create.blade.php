                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('family_last_name') is-invalid @enderror" id="family_last_name" name="family_last_name"
                               inputmode="text" value="{{ old('family_last_name') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="cooperating_agencies" name="cooperating_agencies"
                                  inputmode="text" rows="3" placeholder="複数ある場合は改行区切り">{{ old('cooperating_agencies') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="nearest_station" name="nearest_station"
                               inputmode="text" value="{{ old('nearest_station') }}">
                    </div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between">
...
<script>
    ...
    function clearNameError() {
        ['last_name', 'family_last_name'].forEach(clearFieldError);
    }

    // 本人との関係が変更されたらエラーをクリア
    document.getElementById('family_relationship').addEventListener('change', clearNameError);
