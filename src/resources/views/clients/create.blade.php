                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                               ...
                                               value="{{ old('last_name') }}" placeholder="姓" autocomplete="off">
                                        @error('last_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                    <div class="col-6">
                                        <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                               id="first_name" name="first_name" inputmode="text"
                                               value="{{ old('first_name') }}" placeholder="名" autocomplete="off">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <input type="text" class="form-control @error('last_name_kana') is-invalid @enderror"
                                               ...
                                               value="{{ old('last_name_kana') }}" placeholder="せい" autocomplete="off">
                                    ...
                                    <div class="col-6">
                                        <input type="text" class="form-control @error('first_name_kana') is-invalid @enderror"
                                               ...
                                               value="{{ old('first_name_kana') }}" placeholder="めい" autocomplete="off">
                ...
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-md-3">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-12 col-md">
                                <input type="text" class="form-control" id="address2" name="address2" inputmode="text" value="{{ old('address2') }}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-12 col-md">
                                <input type="text" class="form-control" id="address3" name="address3" inputmode="text" value="{{ old('address3') }}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-12 col-md">
                                <input type="text" class="form-control" id="address4" name="address4" inputmode="text" value="{{ old('address4') }}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
