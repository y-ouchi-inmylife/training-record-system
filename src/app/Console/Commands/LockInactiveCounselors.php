 ...
 *   php artisan counselors:lock-inactive --days=60
 */
class LockInactiveCounselors extends Command
{
    ...
    {
        Log::info('[LockInactiveCounselors] アカウントロック（長期間未ログイン）バッチを開始します');
        ...
        try {
            ...
            $errorMessage = '[LockInactiveCounselors] エラー: ' . $e->getMessage();
