...
| トレーニング記録管理 | S-0401 トレーニング記録登録画面 | POST | `/counseling-records` | トレーニング記録を新規登録する（参加者含む） | auth | 管理者、一般 |
...
| トレーニング記録管理 | S-0404 トレーニング記録編集画面 | PUT | `/counseling-records/{id}` | トレーニング記録を更新する（参加者含む） | auth | 管理者、一般 |
...
**概要**: トレーニング記録を更新する（参加者含む）。

**リクエスト**:
POST /counseling-records と同じ。

**処理**:
- トレーニング記録を更新し、紐づく参加者（複数可）を全削除後に再作成する
- 参加者だけを変更した場合も、トレーニング記録の更新日時・更新者を更新する
...
**処理**:
- 音声記録の要約テキストをトレーニング記録の記録内容に取り込み、トレーニング記録と参加者を作成する
- 参加状況は「参加」で作成する
