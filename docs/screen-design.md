...
**レイアウト方針**
- ヘッダーサマリー・2カラム本体・連絡先アコーディオン・最終更新の 4 ブロックで構成する
...
現行の実装形式（カード＋アコーディオン）を維持する。連絡先セクションは独立コンポーネント化しない。

| 項目名 | 種類 | 必須 | 説明 |
|--------|------|------|------|
| 連絡先セクション | アコーディオン |  | カードヘッダーに「連絡先」と「入力あり／入力なし」バッジを表示。クリックで展開・折りたたみ |
| 電話番号1 | 表示のみ |  |  |
| 電話番号2 | 表示のみ |  |  |
