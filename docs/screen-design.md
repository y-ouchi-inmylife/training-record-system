...
│  │トレーニング日│担当1│担当2│参加状況│参加形態│初回│トレーニング内容│フェーズ│← ヘッダー固定
│  │3/10 │佐藤  │田中  │参加  │対面  │  │就労トレーニング│就職支援││
│  │2/15 │田中  │     │参加  │電話  │  │生活トレーニング│個人支援││
│  │1/20 │佐藤  │     │参加  │対面  │●│心理トレーニング│個人支援│↕ スクロール
│  │...（5件以上で縦スクロール表示）                 ││
│  └────────────────────────────────────────────── ┘│
│                                                   │
│  ┌─ 支援管理 ──────────────────────────── [▼] ┐│
...
│  15件のトレーニング記録                                            │
│  ┌──┬──────┬────┬─────┬─────┬────┬────┬──┬──────┬────┐│
│  │内部ID│名前      │トレーニング日│担当1│担当2│参加状況│参加形態│初回│トレーニング内容│フェーズ││
│  ├──┼──────┼────┼─────┼─────┼────┼────┼──┼──────┼────┤│
│  │1 │山田太郎│3/10│佐藤  │田中  │参加  │対面  │  │就労トレーニング│就職支援││
│  │2 │鈴木花子│3/8 │田中  │     │ｷｬﾝｾﾙ│電話  │●│生活トレーニング│個人支援││
│  └──┴──────┴────┴─────┴─────┴────┴────┴──┴──────┴────┘│
│                                                           │
│  [< 前へ]  1 2  [次へ >]                                  │
│                                                           │
