...
│  25件のクライアント                   [新規登録]  │
│  ┌──┬────┬────┬──┬──┬────┬────┬──────┬────┐  │
│  │ID│名前│かな│年齢│性別│主担当│支援状態│最終トレーニング日│フェーズ│  │
│  ├──┼────┼────┼──┼──┼────┼────┼──────┼────┤  │
│  │1│山田太郎│やまだ│45│男│佐藤│支援中│2026/3/10│就職支援│  │
│  │2│鈴木花子│すずき│38│女│田中│連絡待ち│2026/2/15│個人支援│  │
│  │...│    │    │  │  │    │      │        │      │  │
│  └──┴────┴────┴──┴──┴────┴────┴──────┴────┘  │
│                                                 │
│  [< 前へ]  1 2 3  [次へ >]                      │
...
|------|------|------|
| 内部ID | 表示のみ | 数値順でソート可能 |
| 名前 | 表示のみ | 「姓・名（本人）」を表示。五十音順でソート可能 |
| かな | 表示のみ | 「せい・めい（本人）」を表示。五十音順でソート可能 |
| 年齢 | 表示のみ |  |
| 性別 | 表示のみ |  |
| 主担当 | 表示のみ |  |
